    ...
    <div id="des">
      <p class="titulo1">Descripción</p>
        <p class="parrafo">La casa campestre la cosecha cuenta con 6 confortables habitaciones, piscina
          ...
          juegos de mesa, internet inalámbrico, zona de juegos para niños, columpios, cancha
          de futbol entre otros y parqueadero.</p>
          <br>
    ...
    <div id="vision">
      <p class="titulo1">Visión</p>
        <p class="parrafo">En el 2020 ser reconocidos como un hotel referente en el Quindío, por ser modelo
          ...
          diferenciada de nuestro servicio, al compromiso con el medio ambiente, la cultura local  y la
          responsabilidad Social Territorial como un valor que da respuesta a las exigencias cada vez mayores
