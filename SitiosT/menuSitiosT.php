<div id="header">
		...
		<img  id='logi' src='../../CSS/IMG/logo-06.png'>
				...
				<ul class="hijos">
					<li><a data-scroll href="#quindio"><span>Quindio</span></a></li>
					<li><a data-scroll href="#risaralda"><span>Risaralda</span></a></li>
					<li><a data-scroll href="#caldas"><span>Caldas</span></a></li>
				</ul>
				</li>
